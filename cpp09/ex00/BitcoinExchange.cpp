...
BitcoinExchange::BitcoinExchange()
{
	...
	this->curr_month = 0;
	this->curr_year = 0;
	this->ifs.open("data.csv", std::ifstream::in); // sadece okum yetkisi vermek için
	if (!this->ifs.is_open())
	...
	while(std::getline(this->ifs, line))
	{
		...
		curr_stamp = this->curr_year * 100 + this->curr_month * 10 + this->curr_day; // 2009-1-2 2009*100+1*10+2 = 20912
		this->map.insert(std::pair<int, float>(curr_stamp, rate));// 2009-01-02 değil 20912 
	}
}
